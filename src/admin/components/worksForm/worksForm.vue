<template lang="pug">
  form(:class="{activeform: isActiveForm}").works-form
    .titlerow
    ...
    .works-add
      .works-add__imgwrap()
        ...
        .works-add__desc
          ...
          .works-add__save
            button(type="submit" @click.prevent="clearForm").works-add__cancel Отмена
...
<style lang="postcss" scoped src="./worksForm.pcss">
