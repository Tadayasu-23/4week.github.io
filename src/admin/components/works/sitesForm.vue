         ...
         .works-add
            .works-add__imgwrap()
               .works-add__image()
                  ...
                  .works-add__imgdesc.works-add__imgdesc2(v-show="!filePreview") Загрузить изображение
            ...
            .works-add__desc
               ...
               label.works-add__row
                  ...
                  input(type="text" placeholder="https://www.porsche-pulkovo.ru" v-model="formdata.link").works-add__text
